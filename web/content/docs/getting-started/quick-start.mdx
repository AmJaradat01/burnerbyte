...
Once the wizard finishes it drops you at the sign-in screen. Use the admin
account you just created — or a configured SSO provider, if you set one up.
...
![Inbox reader](/screenshots/email.png)
