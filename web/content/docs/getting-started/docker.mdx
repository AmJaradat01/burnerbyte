...
POSTGRES_PORT=5432        # dev overlay only — the base stack publishes no DB port

# Redis
REDIS_PORT=6379           # dev overlay only
...
MINIO_PORT=9000           # dev overlay only
MINIO_CONSOLE_PORT=9001   # dev overlay only
