...
2. **Database indexes** — Ensure all 47 migrations are applied (74 indexes)
...
- **GitLab Issues:** [gitlab.com/amjaradat01/burnerbyte/-/issues](https://gitlab.com/amjaradat01/burnerbyte/-/issues)
