...
echo ""
echo "Next steps:"
echo "  1. Point DNS: burnerbyte.com A → 46.225.107.191"
echo "  2. Point DNS: burnerbyte.com AAAA → 2a01:4f8:1c1c:4fd0::1"
echo "  3. Point DNS: mail.burnerbyte.com A → 46.225.107.191"
echo "  4. Add MX record for your domains → mail.burnerbyte.com"
echo "  5. Add Jenkins deploy SSH key to /root/.ssh/authorized_keys"
echo "  6. Update Jenkins 'burnerbyte-deploy-host' credential to 46.225.107.191"
