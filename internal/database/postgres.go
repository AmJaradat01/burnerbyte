...
// DBTX is the common interface for pgxpool.Pool and pgx.Tx so repositories
// can accept either a pool or a transaction.
type DBTX interface {
...
// WithTx executes fn inside a PostgreSQL transaction. It commits on success
